...
function DrawerConents(props){
	...
	<DrawerContentScrollView {...props}>
		...
		<DrawerItem style={{justifyContent:'center',alignSelf:'center',margin:10}} labelStyle={{fontSize:16}}label="โปรไฟล์" icon={(props) => <Icons {...props} name="user-alt" size={20} />} onPress={() => navigation.navigate("Profile")}/>
