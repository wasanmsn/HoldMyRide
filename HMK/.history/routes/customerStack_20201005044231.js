...
function customerStack({ navigation }){
	...
	return (
		<Drawer.Navigator 
			...
			>
			<Drawer.Screen name = "Parkings" component= {bottomtabs("Parkings")}
			/>
			<Drawer.Screen name = "Profile" component= {bottomtabs("Profile")}
			/>
			<Drawer.Screen name = "Cars" component= {bottomtabs("Cars")}
			/>

			<Drawer.Screen name = "Payments" component= {bottomtabs("Payments")}
			/>
		</Drawer.Navigator>
	);
