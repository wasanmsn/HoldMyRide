...
function DrawerConents(props){
	...
	<DrawerContentScrollView {...props}>
		...
		<Divider/>
		<DrawerItem style={{justifyContent:'space-between',alignSelf:'center',margin:10}} labelStyle={{fontSize:16}} label="โฮสต์"  icon={(props) => <Icons {...props} style={{alignSelf:'flex-start'}} name="parking" size={20} />} onPress={() => navigation.navigate("Parkings")}/>
		<DrawerItem style={{justifyContent:'space-between',alignSelf:'center',margin:10}} labelStyle={{fontSize:16}} label="โปรไฟล์" icon={(props) => <Icons {...props} style={{alignSelf:'flex-start'}} name="user-alt" size={20} />} onPress={() => navigation.navigate("Profile")}/>
