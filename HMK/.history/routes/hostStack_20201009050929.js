...
function DrawerConents(props){
	...
	<DrawerContentScrollView {...props}>
		...
		<Divider/>
		<DrawerItem style={{justifyContent:'space-between',alignSelf:'center',margin:10}} labelStyle={{fontSize:16}} label="ลูกค้า"  icon={(props) => <Icons {...props} name="parking" size={20} />} onPress={() => navigation.navigate("Parkings")}/>
