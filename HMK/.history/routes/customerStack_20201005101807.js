...
function DrawerConents(props){
	...
	<DrawerContentScrollView {...props}>
		...
		<Divider/>
		<DrawerItem label={(props) => <Text {...props}>โฮสต์ <Icons {...props} name="parking" size={20} /> </Text>}  icon={(props) => <Icons {...props} name="parking" size={20} />} onPress={() => navigation.navigate("Parkings")}/>
