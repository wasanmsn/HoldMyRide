...
function DrawerConents(props){
	...
	<DrawerContentScrollView {...props}>
		...
		<Divider/>
		<DrawerItem style={{justifyContent:'center',alignSelf:'center',margin:10}} labelStyle={{}} label={("โฮสต์")}  icon={(props) => <Icons {...props} name="parking" size={20} />} onPress={() => navigation.navigate("Parkings")}/>
