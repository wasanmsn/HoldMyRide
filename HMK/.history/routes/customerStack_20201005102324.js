...
function DrawerConents(props){
	...
	<DrawerContentScrollView {...props}>
		...
		<Divider/>
		<DrawerItem style={{justifyContent:'center',alignSelf:'center',margin:10}} labelStyle={{fontSize:16}} label={("โฮสต์")}  icon={(props) => <Icons {...props} name="parking" size={20} />} onPress={() => navigation.navigate("Parkings")}/>
		<DrawerItem style={{justifyContent:'center',alignSelf:'center',margin:10}} labelStyle={{fontSize:16}}label="โปรไฟล์" icon={(props) => <Icons {...props} name="address-card" size={20} />} onPress={() => navigation.navigate("Profile")}/>
		<DrawerItem style={{justifyContent:'center',alignSelf:'center',margin:10}} labelStyle={{fontSize:16}}label="โรงรถ" icon={(props) => <Icons {...props} name="car" size={20} />} onPress={() => navigation.navigate("Cars")}/>
		<DrawerItem style={{justifyContent:'center',alignSelf:'center',margin:10}} labelStyle={{fontSize:16}}label="กระเป๋าเงิน" icon={(props) => <Icons {...props} name="wallet" size={20} />} onPress={() => navigation.navigate("Payments")}/>
		<DrawerItem style={{justifyContent:'center',alignSelf:'center',margin:10}} labelStyle={{fontSize:16}}label="ออกจากระบบ" icon={(props) => <Icons {...props} name="sign-out-alt" size={20} />} onPress={() => signOut()} 
		/>
