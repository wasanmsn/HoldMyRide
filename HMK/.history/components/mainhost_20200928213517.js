	...
	return (
		<View style={page.container}>
			...
			<View style={page.Bigbox}>
				...
				<View style={page.box1}>
					<Button title="Customers"  type='clear'buttonStyle={[page.box2,{backgroundColor:'#02f59c'}]} titleStyle={page.fontbox} onPress={() => navigation.navigate('Customers')} />
					<Button title="Payments"  type='clear' buttonStyle={[page.box2,{backgroundColor:'#ffcb69'}]} titleStyle={page.fontbox} onPress={() => navigation.navigate('Payment')} />
				</View>
			</View>
		</View>	
	);
