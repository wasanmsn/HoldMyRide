...
import {CardมButton} from 'react-native-paper'
...
function details({route,navigation}){
    ...
    return(
        <Linergrade  colors={['#78d5f5','#787ff6']} start={{x: 0, y: 0}} end={{x: 1, y: 1}} style={{flex:1}} style={page.container}>
            <Header />
            <Card style={{flexDirection:'row',justifyContent:'space-evenly',margin:5,backgroundColor:'#1ca7ec'}}> 
