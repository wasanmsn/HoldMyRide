        ...
        <LinearGradient colors={['#1ca7ec','#4adede']} start={{x: 0, y: 0}} end={{x: 1, y: 1}}  style={page.container}>
            ...
            <View style={{backgroundColor:(Data.verified ? '#32e361':'red'),height:50,width:100,flexDirection:'column',justifyContent:'center',margin:5,borderColor:'black',borderWidth:2.5,borderRadius:5}}>
                ...
                <View style={[page.box2,{justifyContent:'space-evenly',margin:20,padding:15}]}>
                    {edit ? (<Button title="กลับ" containerStyle={{width:100,backgroundColor:'#7bd5f5',}} onPress={() => navigation.goBack()} >

                    </Button>):(<Button title="ยกเลิก" containerStyle={{width:100,backgroundColor:'#7bd5f5',}} onPress={() => {
                        setData(temp)
                    ...
                    {edit ? (<Button title="แก้ไข" containerStyle={{width:100,backgroundColor:'#7bd5f5',}} onPress={() => {
                        setTemp(Data)
                        setEdit(false)
                       }}>
                        
                        </Button>):(<Button title="เสร็จสื้น" containerStyle={{width:100,backgroundColor:'#7bd5f5',}} onPress={() => {
