        ...
        <View style={page.container}>
            ...
            <Card style={{}}>
               <Card.Title
                ...
                subtitleStyle={{color:'blue',alignSelf:'flex-end',margin:10}}
                subtitle={`${balance} baht`}
               />
            </Card>
            <ScrollView style={page.box1}>
                ...
                payments.map((item,index) => 
                    ...
                    (<Card key={index} style={{borderColor:'black',borderWidth:1,height:85,marginVertical:15,flexDirection:'row',justifyContent:'space-between'}} 
