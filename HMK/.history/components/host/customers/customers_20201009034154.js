    ...
    return(
        <View>
            ...
            <ScrollView style={{height:height*0.8}} >
                ...
                <Button mode='outlined' contentStyle={{borderColor:toggle.borderColor,backgroundColor:toggle.backgroundColor,borderWidth:1,height:70,marginVertical:5,flexDirection:'row',justifyContent:'space-between'}} >
                   Test
                </Button>
