        ...
        <View>
            ...
            <ScrollView style={{height:height*0.8}} >
                <View>
                    ...
                    requests.map((item,index) => (<Card key={index} style={{borderColor:'#1ca6d4',borderWidth:1,height:70,marginVertical:5,flexDirection:'row',justifyContent:'space-between'}} 
                        onPress={ async () => {
