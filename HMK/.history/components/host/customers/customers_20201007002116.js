        ...
        <View>
            ...
            <ScrollView style={{height:height*0.8}} >
                <View>
                    ...
                    requests.map((item,index) => (<Card key={index} style={{borderColor:'black',borderWidth:1,height:70,marginVertical:5,flexDirection:'row',justifyContent:'space-between'}} 
                        onPress={ async () => {
                    ...
                    >
                        <Card.Title title={"ลูกค้า "+item.data.name} subtitle={"ระยะเวลา "+item.data.days+"\nการจ่าย "+item.data.payment_method}/>
