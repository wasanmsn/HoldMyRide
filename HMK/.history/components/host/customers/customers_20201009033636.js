        ...
        <View>
            ...
            <ScrollView style={{height:height*0.8}} >
                <View>
                    ...
                    requests.map((item,index) => (<Button key={index} style={{borderColor:toggle.borderColor,backgroundColor:toggle.backgroundColor,borderWidth:1,height:70,marginVertical:5,flexDirection:'row',justifyContent:'space-between'}} onPress={ async () => {                         
