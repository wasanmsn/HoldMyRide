            ...
            <ScrollView style={{height:height*0.6}}>
                <Card style={styles.nAMEBOX}>
                 ...
                 <View >
                    ...
                    <Card style={{alignSelf:'stretch',borderColor:'black',borderWidth:2}}>
                        <Card.Title title={"พาหนะ"} right={(props) =><Button {...props} title='รูปรถ' onPress={toggleOverlay}></Button> } />
                        <Card.Content>
                            <Text >ป้ายทะเบียน : {vehicels.data.Plate} {'\n'}ชนิด : {vehicels.data.Type.toUpperCase()} </Text>
                        </Card.Content>
