            ...
            <ScrollView style={{height:height*0.6}}>
                <Card style={styles.nAMEBOX}>
                 ...
                 <View >
                    ...
                    <Card style={{alignSelf:'stretch',borderColor:'black',borderWidth:2,backgroundColor:'#128cb5'}} onPress={toggleOverlay} >
                        ...
                        <Card.Content>
                            ...
                            <Text >ฝาก {request.days} วัน </Text>
                            <Text >บริการรับถึงที่ {request.service == 'pickUp' ? 'Yes' : 'No'} </Text>
                            <Text >การจ่าย {request.payment_method.toUpperCase()} </Text>
                        </Card.Content>
