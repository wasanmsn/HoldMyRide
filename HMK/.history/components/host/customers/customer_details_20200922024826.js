...
export default function customer_detail({route,navigation}){
    ...
    const acceptRequest = async () =>{
        try {
            ...
            await firestore().collection('payment_History').add({
                ...
                Alert.alert('Request accepted',[{text:'OK',onPress: () => navigation.navigate('Home')}],{ cancelable: false })
    ...
    const confirmDecline =  () => {
        Alert.alert('Do you want to decline this request?',[{text:'Yes',onPress: () => delclinceRequest()},{text:'No',style:'cancle'}],{ cancelable: false })
    }
