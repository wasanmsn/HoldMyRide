        ...
        <View style={page.container}>
            ...
            <Portal>
                ...
                <Dialog.Title>เติมเงิน</Dialog.Title>
                    ...
                    <Dialog.Actions>
                        <Button contentStyle={{width:150}} mode='contained' onPress={hidDiag}>เติมเงิน</Button>
                        <Button contentStyle={{width:150}} mode='contained' onPress={hidDiag}>ยกเลิก</Button>
                    </Dialog.Actions>
                </Dialog>                
            </Portal>
        </View>
