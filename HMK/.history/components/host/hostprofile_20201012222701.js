        ...
        <LinearGradient colors={['#1ca7ec','#4adede']} start={{x: 0, y: 0}} end={{x: 1, y: 1}}  style={page.container}>
            ...
            <View style={{backgroundColor:(Data.verified ? '#32e361':'red'),height:50,width:100,flexDirection:'column',justifyContent:'center',margin:5,borderColor:'black',borderWidth:2.5,borderRadius:5}}>
                ...
                <View style={[page.box2,{justifyContent:'space-evenly',margin:20,padding:15}]}>
                    {edit ? (<Button contentStyle={{width:100,backgroundColor:'#1f2798'}} mode='contained' onPress={() => navigation.goBack()} >กลับ

                    </Button>):(<Button contentStyle={{width:100,backgroundColor:'#1f2798'}} mode='contained' onPress={() => {
                        setData(temp)
                    ...
                    {edit ? (<Button contentStyle={{width:100,backgroundColor:'#1f2798'}} mode='contained' onPress={() => {
                        setTemp(Data)
                        setEdit(false)
                       }}>
                        แก้ไข
