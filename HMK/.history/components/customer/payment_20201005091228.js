    ...
    return (
        <View style={page.container}>
            ...
            <View style={[page.box2,{justifyContent:'space-evenly',margin:20,padding:15}]}>
                ...
                <Button contentStyle={{width:100}}  onPress={() => navigation.goBack()}>กลับ</Button>
                <Button contentStyle={{width:100}}  onPress={showDiag}>เติมเงิน</Button>
                </View>
            <Portal>
                ...
                <Dialog.Title>เติมเงิน</Dialog.Title>
                    ...
                    <Dialog.Actions style={{justifyContent: 'space-around'}} >
                        <Button contentStyle={{width:75}}  onPress={hidDiag}>ยกเลิก</Button>
                        <Button contentStyle={{width:75}}  onPress={() => {
