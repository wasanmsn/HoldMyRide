...
export default function host_details({route,navigation}){
    ...
    const sendRequest = async () =>{
        try {
            ...
            .then(() =>{
                Alert.alert('Request is sent.','Your request is on the way to the host right now. Please wait for your host to confirm your request.',[{text:'OK',onPress: () => navigation.goBack()}],{ cancelable: false })
            })
        } catch (error) {
            console.log(error)
        }
