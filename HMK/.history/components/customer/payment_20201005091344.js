    ...
    return (
        <View style={page.container}>
            ...
            <View style={[page.box2,{justifyContent:'space-evenly',margin:20,padding:15}]}>
                ...
                <Button title="กลับ" containerStyle={{width:100}} onPress={() => navigation.navigate("addCar")}  />
                <Button title="เติมเงิน" containerStyle={{width:100}} onPress={() => navigation.navigate("addCar")}  />
                </View>
            <Portal>
