            ...
            <ScrollView style={page.box1} >
                ...
                <Divider style={{ backgroundColor: '#8C7171' }} />
                    ...
                    <View  style={page.box2}>
                        ...
                        <Input disabledInputStyle={{color:'black'}} inputStyle={{fontSize:12,color:'#8C7171',bottom:-16}} onChangeText={( text => {
                    ...
                    <View  style={page.box2}>
                        ...
                        <Input disabledInputStyle={{color:'black'}} keyboardType='number-pad' inputStyle={{fontSize:12,color:'#8C7171',bottom:-16}} onChangeText={( text => {
                    ...
                    <View  style={page.box2}>
                        ...
                        <Input disabledInputStyle={{color:'black'}} inputStyle={{fontSize:12,color:'#8C7171',bottom:-16}} value={Data.DoB != null ? new Date(Data.DoB).toDateString() : null} disabled={true}>
                   ...
                   <Button title="Edit Birth" containerStyle={{width:100}} buttonStyle={{height:20}} titleStyle={{fontSize:12}}  
                    ...
                    <View  style={page.box2}>
                        ...
                        <Input disabledInputStyle={{color:'black'}} inputStyle={{fontSize:12,color:'#8C7171',bottom:-16}} value={Data.Age ? Data.Age.toString() : ''} disabled={true}>
                    ...
                    <View  style={page.box2}>
                        ...
                        <Input disabledInputStyle={{color:'black'}} inputStyle={{fontSize:12,color:'#8C7171',bottom:-16}}  value={Data.Email ? Data.Email : ''} disabled={true}>
