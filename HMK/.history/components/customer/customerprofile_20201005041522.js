                ...
                <Divider style={{ backgroundColor: '#8C7171' }} />
                   ...
                   <Button title="Edit Birth" containerStyle={{width:100}} buttonStyle={{height:20}} titleStyle={{fontSize:12}}  
                    ...
                    <View  style={page.box2}>
                        ...
                        <Input disabledInputStyle={{color:'black',opacity:1}} keyboardType='number-pad' inputStyle={{fontSize:12,color:'#black',bottom:-16}} value={Data.Age ? Data.Age.toString() : ''} disabled={true}>
                    ...
                    <View  style={page.box2}>
                        ...
                        <Input disabledInputStyle={{color:'black',opacity:1}} keyboardType='email-address' inputStyle={{fontSize:12,color:'black',bottom:-16}}  value={Data.Email ? Data.Email : ''} disabled={true}>
