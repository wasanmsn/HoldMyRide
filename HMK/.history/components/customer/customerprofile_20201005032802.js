            ...
            <ScrollView style={page.box1} >
                ...
                <Divider style={{ backgroundColor: '#8C7171' }} />
                    ...
                    <View  style={page.box2}>
                        ...
                        <Input disabledInputStyle={{color:'black',opacity:1}} inputStyle={{fontSize:12,color:'#8C7171',bottom:-16}} value={Data.DoB != null ? new Date(Data.DoB).toDateString() : null} disabled={true}>
