    ...
    React.useEffect( async () => {
        if(isFocused){
            Geolocation.getCurrentPosition( async info => {
                ...
                let res = await fetch('https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&origins=14.9017703,102.0082781&destinations=14.9144581,102.02579677&key=AIzaSyA2VgWQCpmBg8I_GUT7rrxe1ANgGKYRq-4')
                console.log(res)
