        ...
        <View style={{flex:1}}>
            ...
            <Overlay isVisible={visible} onBackdropPress={toggleOverlay} >
                        <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                            ...
                            Service : {data.Service ? 'None' : 'Pick Up'} {'\n'}
                            Distance : {item.distancematrix.distance.value * 0.001 < price.distance_rate_k ? item.distancematrix.distance.value * 0.001 + 'KM : ' + price.below_distance_rate +'฿' :item.distancematrix.distance.value * 0.001 + 'KM : ' +item.distancematrix.distance.value * 0.001*price.distance_price_k +'฿'} {'\n'}
                            Total : {data.Total} ฿ {'\n'}
                            ...
                            <View style={{flexDirection:'row',marginVertical:20}}>
                                ...
                                <Button title="OK" style={styles.overlar_btns} containerStyle={{width:100,marginLeft:15}} onPress={() => {
                                    ...
                                    firestore().collection('vehicles').doc('wyw3JIUoP5As8qWZ7Nx9').update({
                                        expiredate:firestore.Timestamp.fromDate(expireDate),
                                        checkIn:firestore.Timestamp.fromMillis(date),
