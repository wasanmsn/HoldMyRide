                ...
                await query.get().then(val => {
                    val.docs.forEach(id => {
                        firestore().collection('host').doc(id.id).get().then( data => {
                            ...
                            console.log(url)
                            fetch('https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&origins=14.9017703,102.0082781&destinations=14.9144581,102.02579677&key=AIzaSyA2VgWQCpmBg8I_GUT7rrxe1ANgGKYRq-4').then( res => {
