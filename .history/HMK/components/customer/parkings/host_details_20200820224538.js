            ...
            <Overlay isVisible={visible} onBackdropPress={toggleOverlay} >
                        <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                            ...
                            <View style={{flex:1,flexDirection:'row',marginVertical:20,justifyContent:'center'}}>
                                <Button title="CANCLE" style={styles.back2} containerStyle={styles.cancle_btn} onPress={() => {
                                    navigation.goBack()
                                }} />
                                <Button title="OK" style={styles.back2} containerStyle={styles.ok_btn} onPress={() => {
                                    navigation.goBack()
                                }} />                                
                            </View>
                        </View>
