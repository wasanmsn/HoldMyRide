        ...
        <View style={{flex:1}}>
            ...
            <Overlay isVisible={visible} onBackdropPress={toggleOverlay} >
                        <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                            ...
                            <View style={{height:1,alignSelf:'stretch',borderColor:'blue',borderWidth:2}}></View>
                            <View style={{flex:1,flexDirection:'row',marginVertical:20,justifyContent:'space-evenly'}}>
                                <Button title="CANCLE" style={styles.overlar_btns} containerStyle={styles.cancle_btn} onPress={() => {
                                    navigation.goBack()
                                }} />
                                <Button title="OK" style={styles.overlar_btns} containerStyle={styles.ok_btn} onPress={() => {
                                    navigation.goBack()
                                }} />                                
                            </View>
                        </View>
