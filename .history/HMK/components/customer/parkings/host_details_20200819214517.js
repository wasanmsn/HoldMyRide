            ...
            <ScrollView >
                ...
                <View style={styles.back_btnRow}>
                    ...
                    <View style={styles.done_btn}>
                        ...
                        onPress={() => {
                            console.log(data)
                            const distance = item.distancematrix.distance
                            var kilo_price = distance < price.distance_rate_k ? price.below_distance_rate:price.distance_price_k*distance
                            var day_price = data.value.vehicle.date.Type == "car" ? 100*data.Days : 27*data.Days
                            var tot = data.Service ? kilo_price+day_price : day_price
                            setData({...data,Total:tot})
                            console.log(data)
                        }}
                        >DONE</Text>
                    </View>
