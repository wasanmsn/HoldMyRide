    ...
    return(
        <View>
            ...
            <ScrollView >
                <View>
                    {requests.length != 0 ? 
                    requests.map((item,index) => (<TouchableOpacity key={index} style={{borderColor:'black',borderWidth:1,height:100,marginVertical:5,flexDirection:'row',justifyContent:'space-between'}} 
