...
var defaultImg = '../../../img/account.png'
    ...
    useEffect(() => {
        if(isFocused){
            getPayment().then( async data => {
                ...
                defaultImg = await firestorage().refFromURL(data.vehicel.img).getDownloadURL()
        ...
        <View style={{flex:1}}>
           ...
           <Overlay isVisible={visible} onBackdropPress={toggleOverlay} >
                        ...
                        <Image
                            ...
                            source={ vehicels.img ? {uri: defaultImg} : require(defaultImg) }
