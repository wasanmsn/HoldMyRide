...
export default function customer_detail({route,navigation}){
    ...
    const coordinates = [{latitude:info.coords.latitude,longitude:info.coords.longitude},{latitude:request.coordinates._latitude,longitude:request.coordinates._longitude}]
