...
export default function customer_detail({route,navigation}){
    ...
    const getPayment =  async () => {
        var data = []
        try{
            await item.data.payment.get().then( res => {
                console.log(data)
            })
        }
        catch(err) {
        ...
        <View style={{flex:1}}>
                ...
                <View style={styles.nAMEBOX}>
                    <View style={styles.nameNameRow}>
                        <View style={{flex:1}}>
                            ...
                            <Text>Distance: 
                                {/*item.distancematrix.distance.value * 0.001*/} 
                                km </Text>
                        </View>
            ...
            <Overlay isVisible={visible} onBackdropPress={toggleOverlay} >
                        <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                            ...
                            <Text style={{color:'#0800FF',marginVertical:5}}>
                                    line 1
                             </Text>
                            <View style={{height:1,alignSelf:'stretch',borderColor:'blue',borderWidth:2}}></View>
                            <View style={{flexDirection:'row',marginVertical:20}}>
                                ...
                                <Button title="OK" style={styles.overlar_btns} containerStyle={{width:100,marginLeft:15}} 
                                // onPress={async () => {
                                //     const date = new Date()
