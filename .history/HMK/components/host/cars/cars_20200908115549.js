...
function Cars (){
    ...
    const getDatas = async (ower,imge) =>{
            var name = await ower.get().then(res => {
                res.data().Name
            })
        ...
        <View style={page.container}>
            ...
            <View style={page.box1}>
                <ScrollView>
                    <View  >
                        {vehicles.map(array => {
                            getDatas(array.owner,array.pic).then((data) => (
                            ...
                            <View style={{marginVertical:15,right:20}}>
                               ...
                               <View style={{marginVertical:15,right:20}}>
                                   ...
                                   source={ data.img ? {uri: data.img} : require(defaultImg) }
